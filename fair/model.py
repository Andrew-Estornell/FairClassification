...
class Model:
    ...
    def predict_proba(self, X):
        ...
        return np.array([[1 - y, y] for y in y_hat])
    ...
    def set_params(self, **params):
        ...
        nested_params = {}  # grouped by prefix
    ...
    def set_options(self, C=None, printflag=None, heatmapflag=None, heatmap_iter=None, heatmap_path=None,
                        max_iters=None, gamma=None, fairness_def=None):
    ...
    def __init__(self, sense_feats, predictor_param_dict=None, C=10, printflag=False, heatmapflag=False, heatmap_iter=10, heatmap_path='.', max_iters=10,
                        gamma=0.01, fairness_def='FP', predictor=linear_model.LinearRegression()):
        self.sense_feats = sense_feats
        self.C = C
        self.printflag = printflag
        self.heatmapflag = heatmapflag
        self.heatmap_iter = heatmap_iter
        ...
        self.predictor_param_dict = predictor_param_dict
        if predictor_param_dict is not None:
            self.predictor.set_params(**predictor_param_dict)
